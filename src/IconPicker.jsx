...
export const ICON_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { value: '🧴', label: 'Njega', Icon: WashingMachine },
...
export function IconVisual({ value, title = '', size = 25, strokeWidth = 2.4 }) {
  ...
  if (!meta) return <span className="emojiFallback">{value || '⭐'}</span>;
          ...
          <div className="premiumIconGrid">
            {group.items.map(({ value: itemValue, label, Icon }) => {
              ...
              return (
                ...
                >
                  <span className="premiumIconSymbol"><Icon size={23} strokeWidth={2.45} /></span>
                  <small>{label}</small>
                </button>
              );
            })}
