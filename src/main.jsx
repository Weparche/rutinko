...
function TodayScreen(props) {
  return <>
    ...
    <TaskSection {...props} title="Gotovo" tasks={props.tasks.filter(props.isResolved)} icon="✅" defaultCollapsed completed />
  </>;
}
